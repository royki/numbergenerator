...
class GeneratorTestSuite extends FunSuite with Matchers {
    test("1st 5 random numbers") {
        ...
        Produce.countPair(generatorA, generatorB) shouldBe 1
    }
    ...
    test("1st 40000 random numbers") {
        ...
        Produce.countPair(generatorA, generatorB) shouldBe 3
    }
    ...
    test("1st 400000 random numbers") {
        ...
        Produce.countPair(generatorA, generatorB) shouldBe 5
    }
    ...
    test("1st 4000000 random numbers") {
        ...
        Produce.countPair(generatorA, generatorB) shouldBe 50
    }
    ...
    test("1st 40000000 random numbers") {
        ...
        Produce.countPair(generatorA, generatorB) shouldBe 588
    }
}